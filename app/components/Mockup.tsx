    ...
    return (
        <div className="mockup-wrapper">
            <div className="app-grid mockup-grid">
                <div className="panel sidebar-panel mockup-panel feature-hover" data-tooltip="Seamlessly browse any GitHub repository">
                ...
                <div className="panel content-panel mockup-panel feature-hover" data-tooltip="Instant, AI-driven architectural analysis">
